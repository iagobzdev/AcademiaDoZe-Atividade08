...
public class MatriculaInfrastructureTests : TestBase
{
    ...
    public MatriculaInfrastructureTests()
    {
        ...
        _matriculaRepo = new MatriculaRepository(ConnectionString);
    }
        ...
        Arquivo? laudo = null)
    {
        ...
        var matriculaResult = Matricula.Criar(
            id: 0, aluno: aluno, plano: plano, dataInicio: inicio, objetivo: "Iago",
            restricoesMedicas: restricoes, laudoMedico: laudo, observacoesRestricoes: obsRestricao
        );
