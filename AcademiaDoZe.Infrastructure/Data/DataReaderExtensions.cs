...
public static class DataReaderExtensions
{
    ...
    {
        return DateTime.Parse(reader[columnName].ToString()!, CultureInfo.InvariantCulture);
    }

    public static DateOnly GetDateOnlyValue(this DbDataReader reader, string columnName)
    {
        return DateOnly.FromDateTime(DateTime.Parse(reader[columnName].ToString()!, CultureInfo.InvariantCulture));
    }
}
